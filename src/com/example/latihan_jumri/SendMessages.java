...
public class SendMessages extends Activity implements OnItemSelectedListener {
	
	private String TAG = SendMessages.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bkirim.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(SendMessages.this, ContactMessages.class);
	...
	private class SendMessage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SendMessages.this);
	...
	private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(SendMessages.this, android.R.layout.simple_spinner_item, arrayList); 
