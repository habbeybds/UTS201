...
public class ReplyMessages extends Activity {
	
	private String TAG = ReplyMessages.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bkirim.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(ReplyMessages.this, ContactMessages.class);
	...
	private class SendMessage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ReplyMessages.this);
